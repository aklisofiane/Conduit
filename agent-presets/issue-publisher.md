...
3. For each finding across all reviewers, create a GitHub issue with:
   ...
   - Body: Include the file, lines, description, severity/impact, and suggested fix from the reviewer's output. Add a `<!-- conduit-nightly-review -->` marker so these issues are identifiable.
