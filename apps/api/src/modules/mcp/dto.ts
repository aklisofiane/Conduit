 ...
 * the server is bound to a workflow connection, the connection id needed to
 * resolve the `{{credential}}` placeholder. Without that resolution remote
 * MCP servers (e.g. https://api.githubcopilot.com/mcp/) reject `tools/list`
