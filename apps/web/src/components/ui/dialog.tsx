...
const dialogTitleClass = 'm-0 font-sans text-base font-semibold text-[var(--color-text)]';

const dialogDescriptionClass = 'm-0 font-mono text-small text-[var(--color-text-muted)]';
...
>(function DialogOverlay({ className, ...props }, ref) {
  return <RxDialog.Overlay ref={ref} className={cn(dialogOverlayClass, className)} {...props} />;
});
...
export const DialogContent = forwardRef<HTMLDivElement, DialogContentProps>(function DialogContent(
  ...
  return (
    <RxDialog.Portal>
      ...
      <RxDialog.Content ref={ref} className={cn(dialogContentClass, className)} {...props}>
        {children}
      </RxDialog.Content>
    </RxDialog.Portal>
  );
...
>(function DialogTitle({ className, ...props }, ref) {
  return <RxDialog.Title ref={ref} className={cn(dialogTitleClass, className)} {...props} />;
});
...
>(function DialogDescription({ className, ...props }, ref) {
  return (
    <RxDialog.Description ref={ref} className={cn(dialogDescriptionClass, className)} {...props} />
  );
});
