...
export function NodeError({ node }: { node: NodeRunRow }) {
  ...
  return (
    <div className="h-full overflow-y-auto px-6 py-5">
      <pre className="whitespace-pre-wrap rounded-md border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.06)] p-3 font-mono text-small leading-relaxed text-[var(--color-error)]">
        {node.error}
      </pre>
    </div>
  );
