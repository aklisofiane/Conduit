...
| `mcp-stub/` | A tiny stdio MCP server (`server.mjs`) used in place of real GitHub MCP servers. Exposes `echo`, `add`, `fail` — enough to exercise introspection and tool-call paths. |
